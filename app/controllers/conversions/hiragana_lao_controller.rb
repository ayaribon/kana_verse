class Conversions::HiraganaLaoController < ApplicationController
  ...
  def convert_hiragana_to_lao(hiragana)
    hiragana_to_lao_long = {
      ...
      # か行
      "か" => "ຄາ", "き" => "ຄີ", "く" => "ຄູ", "け" => "ເຄ", "こ" => "ໂຄ",

      # さ行
      "さ" => "ຊາ", "し" => "ຊີ", "す" => "ຊູ", "せ" => "ເຊ", "そ" => "ໂຊ",

      # た行
      "た" => "ຕາ", "ち" => "ຈີ", "つ" => "ສູ", "て" => "ເຕ", "と" => "ໂຕ", "っ" => "ສ",

      # な行
      "な" => "ນາ", "に" => "ນີ", "ぬ" => "ນູ", "ね" => "ເນ", "の" => "ໂນ",

      # は行
      "は" => "ຮາ", "ひ" => "ຮີ", "ふ" => "ຮູ", "へ" => "ເຮ", "ほ" => "ໂຮ",

      # ま行
      "ま" => "ມາ", "み" => "ມີ", "む" => "ມູ", "め" => "ເມ", "も" => "ໂມ",

      # や行
      "や" => "ຢາ", "ゆ" => "ຢູ", "よ" => "ໂຢ",

      # ら行
      "ら" => "ຣາ", "り" => "ຣີ", "る" => "ຣູ", "れ" => "ເຣ", "ろ" => "ໂຣ",

      # わ行
      "わ" => "ວາ", "を" => "ໂອ", "ん" => "ນ",

      # が行
      "が" => "ກາ", "ぎ" => "ກີ", "ぐ" => "ກູ", "げ" => "ເກ", "ご" => "ໂກ",

      # ざ行
      "ざ" => "ຊາ", "じ" => "ຈີ", "ず" => "ຊູ", "ぜ" => "ເຊ", "ぞ" => "ໂຊ",

      # ば行
      "ば" => "ບາ", "び" => "ບີ", "ぶ" => "ບູ", "べ" => "ເບ", "ぼ" => "ໂບ",

      # ぱ行
      "ぱ" => "ປາ", "ぴ" => "ປີ", "ぷ" => "ປູ", "ぺ" => "ເປ", "ぽ" => "ໂປ",

      # だ行
      "だ" => "ດາ", "ぢ" => "ຈີ", "づ" => "ສູ", "で" => "ເດ", "ど" => "ໂດ",

      # きゃ行
      "きゃ" => "ເຄຍ", "きゅ" => "ຄີວ", "きょ" => "ຄຽວ",

      # しゃ行
      "しゃ" => "ເຊຍ", "しゅ" => "ຊີວ", "しょ" => "ຊຽວ",
      ...
      # ひゃ行
      "ひゃ" => "ເຮຍ", "ひゅ" => "ຮີວ", "ひょ" => "ຮຽວ",

      # みゃ行
      "みゃ" => "ເມຍ", "みゅ" => "ມີວ", "みょ" => "ມຽວ",

      # りゃ行
      "りゃ" => "ເຣຍ", "りゅ" => "ຣີວ", "りょ" => "ຣຽວ",

      # ぎゃ行
      "ぎゃ" => "ເກຍ", "ぎゅ" => "ກີວ", "ぎょ" => "ກຽວ",

      # じゃ行
      "じゃ" => "ຈາ", "じゅ" => "ຈູ", "じょ" => "ໂຈ",

      # びゃ行
      "びゃ" => "ເບຍ", "びゅ" => "ບີວ", "びょ" => "ບຽວ",

      # ぴゃ行
      "ぴゃ" => "ເປຍ", "ぴゅ" => "ປີວ", "ぴょ" => "ປຽວ",
    ...
    hiragana_to_lao_short = {
      ...
      # ば行
      "ば" => "ບະ", "び" => "ບິ", "ぶ" => "ບຸ", "べ" => "ເບະ", "ぼ" => "ໂບະ",

      # ぱ行
      "ぱ" => "ປະ", "ぴ" => "ປິ", "ぷ" => "ປຸ", "ぺ" => "ເປະ", "ぽ" => "ໂປະ",
    ...
    words.each do |word|
      ...
      characters.each_with_index do |char, index|
        ...
        elsif %w[ぁ ぃ ぅ ぇ ぉ あ い う え お].include?(char)
